...
3 Vaihe: Host ja dig komennon käyttö
...
ANSWER SECTION näyttää, että nitaarifi.com -verkkotunnuksella on yksi A-tietue, joka osoittaa IP-osoitteeseen 94.237.18.62. Tämä tarkoittaa, että verkkotunnuksen nitaarifi.com liikenne ohjataan tälle IP-osoitteelle.
Query time kertoo, kuinka kauan komennon suorittaminen kesti (468 msec).
SERVER kertoo, mitä nimipalvelinta käytettiin kyselyyn (10.0.2.3).
MSG SIZE rcvd kertoo vastaanotetun viestin koon (58 tavua).
