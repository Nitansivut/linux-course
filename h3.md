...
Minulla oli paljon haasteita tehtävän tekemisessä, joten aloitin sitä monta kertaa alusta. Viimeisimmällä kerralla aloitin tehtävän poistamalla oletussivuston (000-default.conf) pois käytöstä komennolla sudo a2dissite 000-default. 

Seuraavaksi loin uuden konfiguraatiotiedoston Apachelle komennolla sudo nano /etc/apache2/sites-available/hattu.example.com.conf.

Koska olin tehnyt tämän jo aikaisemmin, niin minulla näkyi aiemman  konfiguraatiotiedoston tiedot, kun annoin edellä mainitun komennon. 

<img src="konf.png" width="600" />

ServerName: Tässä määritin verkkotunnuksen, joka ohjataan tähän virtual hostiin. 
ServerAlias: Määritin mahdollisen vaihtoehtoisen verkkotunnuksen www.hattu.example.com, jotta molemmat versiot verkkotunnuksesta ohjautuvat oikeaan paikkaan.
DocumentRoot: Tämä on se hakemisto, jossa verkkosivun tiedostot sijaitsevat. Määritin sen /home/nita/public_html/hattu.example.com -hakemistoksi, ja nita-muuttuja viittaa minun kotihakemistoon.
Directory: Tällä osalla määrittelin, että kaikille käyttäjille annetaan oikeus lukea ja käsitellä tiedostoja tässä hakemistossa. Tämä mahdollistaa sen, että pystyn itse muokkaamaan sivua ilman sudo-oikeuksia.
...
https://serverfault.com/questions/588380/what-is-the-difference-between-documentroot-and-directory-in-apache2-for-mac-os
