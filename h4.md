...
- Suositeltavaa käyttää yhdessä SSH-avainten kanssa salasanan sijaan.

<ins>Yhteyden muodostaminen palvelimeen</ins>
- Yhdistä palvelimeen SSH-yhteydellä käyttämällä palvelimen IP-osoitetta.
...
- Lokeista voi tunnistaa epäilyttäviä kirjautumisyrityksiä, kuten toistuvat virheelliset salasanayritykset.
...
ChatGPT. (2025). Keskustelu tekoälyn kanssa: Web-palvelimen asennus virtuaalipalvelimelle. OpenAI. 8.2.2025. 
